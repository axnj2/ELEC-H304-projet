...
def current_func_phased_array(q: int, previous_J):
    ...
    for ii in range(NUMBER_OF_ELEMENTS):
        sinusoïdal_point_source(
            ...
            TOTAL_CURRENT / np.sqrt(NUMBER_OF_ELEMENTS), # power for a sinusoidal source is prop to I^2 => divide by sqrt(N)
            FREQ_REF,
            DELTA_T,
            DELTA_X,
...
plt.savefig("images/phased_array_power_distribution_VS_sinuoidal.png", dpi=300, bbox_inches="tight")
#plt.show()
